...
public class Lab0 {
    ...
    // with N up to 500,000 this algorithm will take roughly 500,000^2 =
    // 250,000,000,000 operations
    ...
    // with N up to 500,000 this algorithm will take 500,000 operations, less than
    // 10^8
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < n; i++) {
            int toInput = in.nextInt();
            array.add(toInput);
        }
        // TODO: read the array and call method getMaximumProfit() you want to try
